...
//    Route::get('reports/branch-summary/{branch_id}', 'UserReportCrudController@branchSummary');
    ...
    Route::get('charts/courses', 'Charts\CoursesChartController@response')->name('charts.courses.index');
